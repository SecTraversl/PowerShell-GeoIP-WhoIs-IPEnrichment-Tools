...
.NOTES
  Name:  Get-WhoIs.ps1
  Author:  Travis Logue
  Version History:  4.1 | 2021-03-10 | Added PTR Lookup; Added logic to validate the actual 'startAddress','endAddress', and 'cidrLength' when getting an Array of results in those fields from RIPE and APNIC; such that the final is a scalar value for each of those respective properties
  Dependencies:
  Notes:
